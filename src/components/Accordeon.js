...
const cowboys = [
	{
		image: '/images/avatars/anabel.png',
	...
	{
		image: '/images/avatars/garri.png',
		title: 'Дикий Гарри',
	...
	{
		image: '/images/avatars/pekos.png',
		title: 'Пекос Билл',
	...
	{
		image: '/images/avatars/Cactus.png',
		title: 'Кактус Джек',
...
const cyborgs = [
	{
		image: '/images/avatars/tarakan.png',
	...
	{
		image: '/images/avatars/doktor.png',
		title: 'Доктор Мерлин',
		...
		power: '«Наука в действии» — до конца хода лошадь Джека скачет в два раза быстрее.'
	},
	{
		image: '/images/avatars/yaponochka.png',
	...
	{
		image: '/images/avatars/Koyot.png',
		title: 'Койот Хотото',
	...
	{
		image: '/images/avatars/cyborg-card-1.png',
		title: 'Olegator_17',
			...
			<div id="accordeon-container" className="position-realtive m-w-container" style={{overflow: "hidden"}}>
				<div>
					...
					<div className="accordeon">
						<animated.div className="accordeon-left" id="accordeon-left" onClick={props.handleClickLeft} style={expandLeft}>
							<animated.div className="display-5 text-white">КОВБОИ</animated.div>
							{!props.isOpenRight && <Deck cards={cowboys}/>}
						</animated.div>
						<animated.div className="accordeon-right" id="accordeon-right" onClick={props.handleClickRight} style={expandRight}>
							<animated.div className="display-5 text-white">КИБОРГИ</animated.div>
							{props.isOpenRight && <Deck cards={cyborgs}/>}
						</animated.div>
